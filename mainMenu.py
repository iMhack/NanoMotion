...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_substract = QtWidgets.QLineEdit(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_substract.sizePolicy().hasHeightForWidth())
        self.lineEdit_substract.setSizePolicy(sizePolicy)
        self.lineEdit_substract.setMaximumSize(QtCore.QSize(50, 16777215))
        self.lineEdit_substract.setObjectName("lineEdit_substract")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.lineEdit_substract)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_substract.setToolTip(_translate("MainWindow", "How many times in range to do this ?"))
        self.lineEdit_substract.setText(_translate("MainWindow", "5"))
